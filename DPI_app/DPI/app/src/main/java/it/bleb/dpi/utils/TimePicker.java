 ...
 * https://bleb.it
 *
 * Last modified 28/01/2020 11:09
 */
...
public class TimePicker extends FrameLayout {
    ...
    private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = new OnTimeChangedListener() {
        public void onTimeChanged(it.bleb.dpi.utils.TimePicker view, int hourOfDay, int minute, int seconds) {
        }
    };
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(it.bleb.dpi.utils.TimePicker view, int hourOfDay, int minute, int seconds);
    }
